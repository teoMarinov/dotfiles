...
if [ "$HAS_AOC1" -eq 1 ] && [ "$HAS_AOC2" -eq 1 ]; then
    hyprctl keyword monitor "desc:$AOC_1,1920x1080@144,1537x0,1"
    hyprctl keyword monitor "desc:$AOC_2,1920x1080@60,3458x0,1"
elif [ "$HAS_AOC2" -eq 1 ]; then
    hyprctl keyword monitor "desc:$AOC_2,1920x1080@60,1537x0,1"
